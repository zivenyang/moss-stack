...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_itemeventstore_item_id"), "itemeventstore", ["item_id"], unique=False
    )
    op.create_table(
        "user",
    ...
    op.create_table(
        ...
        sa.Column(
            "provider",
            sa.Enum("PASSWORD", "GOOGLE", "GITHUB", "LDAP", name="identityprovider"),
            nullable=False,
        ),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_identity_provider"), "identity", ["provider"], unique=False
    )
    op.create_index(
        op.f("ix_identity_provider_user_id"),
        "identity",
        ["provider_user_id"],
        unique=False,
    )
